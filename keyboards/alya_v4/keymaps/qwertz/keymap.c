...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        KC_TAB,   DE_ADIA,  DE_Q,    DE_W,    DE_E,    DE_R,     DE_T,
        MO(_M3),            DE_A,    DE_S,    DE_D,    DE_F,     DE_G,
        KC_LSFT,  DE_Y,     DE_X,    DE_C,    DE_V,    DE_B,     KC_BACKSPACE,
        KC_LCTL,  MO(_FN),  KC_LWIN, KC_LALT, MO(_M4), KC_LSFT,  KC_LCTL,

        DE_7,     DE_8,     DE_9,    DE_0,    DE_SS,   DE_CIRC,  KC_PGUP,
        DE_Z,     DE_U,     DE_I,    DE_O,    DE_P,    DE_UDIA,  KC_PGDN,
        DE_H,     DE_J,     DE_K,    DE_L,    DE_ODIA,           MO(_M3),
    ...
    [_FN] = LAYOUT(
        ...
        KC_SCRL,  DE_UDIA,  DE_P,    DE_O,     DE_I,    DE_U,     DE_Z,
        KC_ESC,             DE_ODIA, DE_L,     DE_K,    DE_J,     DE_H,
        KC_LSFT,  DE_MINS,  DE_DOT,  DE_COMM,  DE_M,    DE_N,     KC_PAUSE,
        KC_LCTL,  MO(_FN),  KC_APP,  KC_LALT,  MO(_M4), KC_LSFT,  KC_LCTL,

        KC_F6,    KC_F7,    KC_F8,   KC_F9,   KC_F10, KC_F11,  KC_F12,
        DE_T,     DE_R,     DE_E,    DE_W,    DE_Q,   DE_ADIA, QK_BOOT,
        DE_G,     DE_F,     DE_D,    DE_S,    DE_A,            MO(_M4),
                  DE_B,     DE_V,    DE_C,    DE_X,   DE_Y,    KC_RSFT,
